...
%% Entrada de dados
arquivo = 'resultados_kerschen2_*.txt';

load('kerschen2.mat', 'modelo', 'parametros');
bh=modelo.data;
...
Titulo='Diagrama de bifurcação Kerschen4';
...
%all_data(:, end)=all_data(:, end)/2/pi;
...
bifurcation_idx = strcmp(all_types, 'SN') | strcmp(all_types, 'NS') | ...
                  strcmp(all_types, 'PD') | strcmp(all_types, 'PRS') | ...
                  strcmp(all_types, 'PRC');
